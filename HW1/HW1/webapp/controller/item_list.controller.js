sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.inventoryDemandSupplyAnalysis.controller.item_list", {
		...
		_onObjectListItemPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				this.doNavigate("item_stock_view", oBindingContext, fnResolve, "");
		...
		onInit: function() {
			...
			this.oRouter.getTarget("item_list").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_List_Page_0-content-sap_m_ObjectList-1527751948436",
				"groups": ["items"]
			}];
